...
- Live Site URL: [https://profile-card-component-token.netlify.app/]
...
body{
    ...
    background-position: top 300px left 60em, bottom 10em right 55em ;
    background-repeat:no-repeat;
    font-size: 100%;
}

##  I leant the use of background positoning 
